...
def main():
    ...
    parser.add_argument("--data_dir", default="data/raw", help="Ruta base del dataset (carpeta data/raw del proyecto)")
    ...
    parser.add_argument("--output_dir", default="data/interim", help="Carpeta de salida para artefactos intermedios")
