...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--clean_csv",
        default="salida_preprocesamiento/dataset_limpio_con_split.csv",
        help="Ruta del dataset limpio con variable split.",
    )
    parser.add_argument(
        "--raw_csv",
        default="salida_preprocesamiento/base_integrada_raw.csv",
        help="Ruta de la base integrada raw para derivar metricas de bounding boxes.",
    )
    parser.add_argument(
        "--preprocessing_summary",
        default="salida_preprocesamiento/resumen_preprocesamiento.json",
        help="Ruta del resumen JSON generado por el preprocesamiento.",
    )
    parser.add_argument(
        "--output_dir",
        default="salida_eda",
        help="Carpeta donde se guardaran graficos, tablas y resumenes del EDA.",
    )
